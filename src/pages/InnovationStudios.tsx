...
import TypographyDebugger from "@/components/debug/TypographyDebugger";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              {["Design.", "Build.", "Scale."].map((word, index) => (
                ...
                >
                  <h1 className="hero-title-1 font-simula text-white">
                    {word}
                  </h1>
                </motion.div>
              ))}
            ...
            <motion.p 
              ...
              className="mt-12 hero-text text-white/90 font-lora reading-width-normal"
            >
