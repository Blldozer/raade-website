...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center bg-gradient-to-br from-raade-red from-5% via-raade-gold-start via-30% via-raade-gold-middle via-50% via-raade-gold-end via-70% to-white/30 to-90%">
      {/* Content */}
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8 animate-fade-in">
            ...
            <Button
              variant="outline"
              size="lg"
              className="bg-transparent border-2 border-white/50 text-white hover:bg-white/10 hover:border-white font-semibold text-lg rounded-full px-8 transition-all duration-300 transform hover:-translate-y-1"
