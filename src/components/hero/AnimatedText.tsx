...
const AnimatedText = () => {
  ...
  return (
    <div className="space-y-[var(--space-md)]" ref={containerRef}>
      <h1 
        ref={orgNameRef}
        className="text-raade-gold-start text-fluid-normal font-medium tracking-wide uppercase font-alegreyasans"
      >
        Rice Association for African Development
      </h1>

      <div className="relative">
        <h2 className="text-fluid-h1 font-bold tracking-wide font-zillahighlight">
        ...
        <motion.div 
          ...
          className="absolute -bottom-[var(--space-sm)] left-0 h-1 bg-raade-gold-start"
        />
      </div>
    </div>
  );
