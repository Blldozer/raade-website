...
import { Star, ExternalLink, ChevronRight, Clock } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { TICKET_TYPES_ENUM, getTicketPrice, getRegularTicketPrice } from "./RegistrationFormTypes";
 ...
 * Shows 24-hour sale pricing with original prices strikethrough.
 */
  ...
  return (
    <section id="registration" className="py-16 px-4 md:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 scroll-animate">
          <div className="inline-block mb-4 px-4 py-2 bg-red-100 rounded-full">
            <div className="flex items-center justify-center">
              ...
              <p className="text-red-600 font-bold">24-HOUR SALE - Limited Time Offer!</p>
            </div>
          </div>
          <h2 className="text-4xl font-bold text-raade-navy mb-4 font-simula">Registration Options</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto font-lora">Special 24-hour sale pricing! Secure your spot at the RAADE 2025 African Development Forum.</p>
        </div>
        ...
        <div className="bg-red-50 p-8 rounded-xl mt-12 mb-10 border-2 border-dashed border-red-200 relative">
          ...
          <h3 className="text-xl font-bold text-raade-navy mb-4 font-simula">Student Group Discount - Special Sale!</h3>
