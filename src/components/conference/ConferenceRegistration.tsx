  ...
  return (
    <section id="registration" className="py-16 px-4 md:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          duration: 0.5
            ...
            <Card className="border-t-4 border-t-[#FBB03B] hover:shadow-xl transition-all relative h-full">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-raade-navy mb-4">${studentPrice}</p>
          ...
          delay: 0.2
            ...
            <Card className="border-t-4 border-t-[#FBB03B] hover:shadow-xl transition-all relative h-full">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-raade-navy mb-4">${professionalPrice}</p>
        ...
        <div className="bg-[#FBB03B]/10 p-8 rounded-xl mt-12 mb-10">
