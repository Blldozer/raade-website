        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          duration: 0.5
            ...
            <Card className="border-t-4 border-t-[#FBB03B] hover:shadow-xl transition-all relative h-full">
              ...
              <CardHeader>
                <CardTitle className="text-xl font-simula">Rice Student Ticket</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-3xl font-bold text-raade-navy mb-4">$50</p>
                <p className="text-gray-500 mb-6 font-lora text-sm">For Rice University students only</p>
          ...
          delay: 0.2
            ...
            <Card className="border-t-4 border-t-[#FBB03B] hover:shadow-xl transition-all relative h-full">
              ...
              <CardHeader>
                <CardTitle className="text-xl font-simula">Non-Rice Student Ticket</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-3xl font-bold text-raade-navy mb-4">$65</p>
                <p className="text-gray-500 mb-6 font-lora text-sm">For enrolled students at other universities</p>
                <ul className="space-y-2 mb-8">
                  <li className="flex items-start">
                    <Star className="h-5 w-5 text-[#FBB03B] mr-2 shrink-0 mt-0.5" />
                    <span className="text-gray-600 font-lora">Full conference access</span>
