 ...
 * - Consistent typography with refined aesthetics
 */
  ...
  return (
    ...
    >
      <div className="inline-flex items-center justify-center mb-4">
        ...
        <span className="text-sm uppercase tracking-wider font-lora text-gray-500 italic">April 11-12, 2025</span>
      ...
      <p className="text-lg text-gray-600 max-w-3xl mx-auto font-lora mb-6 italic">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
        ...
        <div className="flex items-center bg-white px-5 py-2 rounded-full shadow-sm">
          ...
          <span className="font-lora">9:00 AM - 10:00 PM</span>
        </div>
      </div>
    </motion.div>
  );
