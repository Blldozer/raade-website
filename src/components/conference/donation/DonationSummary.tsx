  ...
  return (
    <Card className="border border-gray-200 dark:border-gray-700 dark:bg-gray-800 bg-white transition-colors duration-200 mb-6">
      <CardContent className="pt-6">
        <h3 className="text-lg font-simula font-semibold mb-4 text-raade-navy dark:text-white">Donation Summary</h3>
        ...
        <div className="space-y-3 text-sm font-lora">
          ...
          <div className="flex justify-between border-t pt-2 mt-2 border-gray-200 dark:border-gray-700">
            ...
            <span className="font-bold text-raade-navy dark:text-[#FBB03B]">{formattedAmount}</span>
          </div>
          ...
          {message && (
            <div className="border-t pt-2 mt-2 border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm italic text-gray-700 dark:text-gray-200 font-lora">{message}</p>
            </div>
          )}
        </div>
      </CardContent>
