...
const ConferenceHero = () => {
  ...
  return <div className="relative min-h-screen bg-[#FBB03B] overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 z-0 opacity-10">
        {[...Array(15)].map((_, index) => <div key={index} className="absolute w-3 h-3 rounded-full bg-white" style={{
        top: `${Math.random() * 100}%`,
      ...
      <div className="max-w-7xl mx-auto pt-20 px-4 md:px-6 lg:px-8 min-h-screen flex flex-col lg:flex-row items-center">
        ...
        <div className="w-full lg:w-2/5 lg:pr-12 py-12 z-10 bg-[raade-yellow-orange] bg-raade-orange">
          ...
          duration: 0.6
            ...
            <p className="text-lg font-medium text-white font-lora">
            ...
            <div className="space-y-4">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold font-simula text-white">
                BUILDING & DESIGNING
              </h2>
            ...
            <p className="text-raade-navy max-w-lg font-lora">
            ...
            <button onClick={() => navigate("/conference/register")} className="px-8 py-3 bg-raade-navy text-white rounded-md font-medium transition-colors hover:bg-raade-navy/90 font-lora shadow-md">
              Get Tickets
            </button>
          </motion.div>
        </div>
        ...
        <div className="w-full lg:w-3/5 flex flex-col items-center justify-center z-10 py-12">
          ...
          delay: 0.2
            ...
            <div className="mt-16 text-center space-y-4">
              <p className="text-lg font-simula text-raade-navy font-medium">Conference Highlights</p>
              <div className="flex justify-center space-x-4">
                <div className="px-4 py-2 bg-white rounded-md shadow-sm hover:shadow-md transition-shadow cursor-pointer hover:bg-raade-navy hover:text-white">
                  <p className="text-sm font-lora text-raade-navy font-medium">Speakers</p>
                </div>
                <div className="px-4 py-2 bg-white rounded-md shadow-sm hover:shadow-md transition-shadow cursor-pointer hover:bg-raade-navy hover:text-white">
                  <p className="text-sm font-lora text-raade-navy font-medium">Sponsors</p>
                </div>
                <div className="px-4 py-2 bg-white rounded-md shadow-sm hover:shadow-md transition-shadow cursor-pointer hover:bg-raade-navy hover:text-white">
                  <p className="text-sm font-lora text-raade-navy font-medium">Schedule</p>
                </div>
              </div>
            </div>
          </motion.div>
