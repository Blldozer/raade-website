...
/**
 * ConferenceWhy component - Displays information about why different groups should attend
 * 
 * Features:
 * - Uses the 39/61 split layout consistent with other conference sections
 * - Implements WhyAttendTabs component for categorized attendee information
 * - Provides clear value propositions for different attendee types
 * - Includes registration call-to-action for immediate conversion
 */
const ConferenceWhy = () => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row mb-12">
          ...
          >
            <p className="text-lg font-lora p-4 lg:p-0 text-slate-950">
              The distinctive value of the RAADE African development forum is that attendees don't just 
              gain knowledge or contacts – they become part of creating solutions that can spread across the continent.
            </p>
          </motion.div>
        </div>
        
        {/* Tab component for different attendee types */}
        <WhyAttendTabs />
        ...
        >
          ...
          <Button 
            ...
            className="bg-[#FBB03B] hover:bg-[#FBB03B]/90 font-lora text-xl font-bold text-white"
          >
            Register Now
          </Button>
        </motion.div>
