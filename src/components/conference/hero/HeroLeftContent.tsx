...
const HeroLeftContent = () => {
  ...
  return <div className="w-full max-w-4xl mx-auto py-10 z-10 text-center">
      <motion.div initial={{
      opacity: 0,
      y: 20
    }} animate={{
      ...
      duration: 0.6
        ...
        <div className="space-y-2">
          ...
          duration: 0.8,
          delay: 0.4
        }} className="text-6xl lg:text-7xl font-bold font-simula text-white">DEVELOPMENT FORUM</motion.h2>
          <motion.div initial={{
          width: 0,
          opacity: 0
        }} animate={{
