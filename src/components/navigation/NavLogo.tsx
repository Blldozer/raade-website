...
const NavLogo = ({ isScrolled = false, isDarkBackground = false }: NavLogoProps) => {
  // Determine which logo to use based on background color
  const logoSrc = isDarkBackground 
    ? "/logos/RAADE-LOGO-Black-BG.png"  // On dark backgrounds, use logo with black background (white text)
