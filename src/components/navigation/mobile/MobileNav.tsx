 ...
 * - Smooth transitions
 * - Guaranteed visibility with portal rendering
 * 
...
const MobileNav = ({ 
  ...
  return (
    <div className="block md:hidden">
      ...
      {/* 
        Render the mobile menu through a portal to ensure it's at the root level
        This prevents z-index issues and ensures it always displays properly
      */}
