...
const FutureShowcase = () => {
  ...
  useEffect(() => {
    ...
    // We don't need individual animations here as the deck transition 
  ...
  return (
    <div 
      ref={sectionRef}
      className="min-h-screen py-20 md:py-40 overflow-hidden relative"
    >
      ...
      <div className="max-w-[90vw] xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-20">
