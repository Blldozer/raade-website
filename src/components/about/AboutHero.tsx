    ...
    <div className="min-h-screen flex flex-col lg:flex-row about-hero-section" data-background="dark">
      ...
      <motion.div initial={{
        ...
        <div className="px-8 pt-24 pb-16 lg:py-24 lg:px-12 max-w-[600px] mx-auto">
          ...
          <p className="text-[clamp(1rem,1.2vw,1.25rem)] leading-relaxed text-white font-lora font-medium">
      ...
      <motion.div initial={{
        ...
        `}>
          ...
          {!imageLoaded && !imageError && <div className="absolute inset-0 bg-[#4C504A] flex items-center justify-center">
              <div className="text-white text-xl">Loading RAADE's story...</div>
            </div>}
          
          {/* Show image once loaded - Mobile-specific adjustments */}
          {(imageLoaded || !isMobile) && !imageError && <img src="/raade-innov-team-core-2.jpg" alt="RAADE Innovation Studio Team at Rice Business School" className={`
          ...
          {imageError && <div className="absolute inset-0 bg-[#3C403A] flex items-center justify-center">
