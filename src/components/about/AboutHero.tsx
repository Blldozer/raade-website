...
const AboutHero = () => {
  return (
    <div className="min-h-screen relative bg-raade-navy overflow-hidden flex items-center">
      <div className="absolute inset-0 bg-gradient-to-br from-black/50 via-transparent to-transparent z-10" />
      ...
      <div 
        className="absolute inset-0 z-0 bg-gradient-to-b from-raade-navy via
-raade-navy to-black"
      >
