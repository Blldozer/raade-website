        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-16">
          ...
          <div className="w-full lg:w-1/2 space-y-16">
            ...
            delay: 0.2
              ...
              <div className="text-[8rem] font-montserrat font-black text-black leading-none tracking-tighter">6</div>
            ...
            delay: 0.4
              ...
              <div className="text-[8rem] font-montserrat font-black text-black leading-none tracking-tighter">4</div>
              <p className="text-xl text-gray-600 mt-2">
