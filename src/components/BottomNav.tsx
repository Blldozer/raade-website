...
const BottomNav = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 p-2">
      <nav className="max-w-sm mx-auto rounded-4xl bg-gradient-to-r from-[#FFA726]/90 via-[#FF9848]/90 to-[#FF8A6A]/90 backdrop-blur-sm border border-white/10 shadow-lg">
