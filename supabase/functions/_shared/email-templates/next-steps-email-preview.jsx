...
/**
 * Preview version of the Next Steps Email Template for browser display
 * Used for testing and preview purposes 
 */
export const NextStepsEmailPreview = ({
  firstName = "John",
  fullName = "John Doe",
      ...
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          <Section style={mainContentStyle}>
            ...
            <Text style={paragraphStyle}>
              These workshops are designed to be collaborative and engaging - creating natural opportunities for you 
              to connect with others who share your specific interests. We've found this approach creates much more 
